...
class SubVC: UIViewController,UITableViewDelegate, UITableViewDataSource{
    ...
    @IBAction func backPressed(_ sender: UIButton) {
        goToGraphsVC(senderController: self)
    }
    func setTableView(){
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        var cell = tableView.dequeueReusableCell(withIdentifier: "subCell", for: indexPath) as! GraphSubCell
